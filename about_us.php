...
<body>
<div id="history">
<p class="p1">Ally Association</p>
<p class="p3">The Ally Association supervises the graduate programs. 
...
<p class="p2">FUNCTION OF  ALLY </p>
<p class="p3">The function of ALLY includes the following:
<ul class="ul2">
	<li>Promoting graduate programs</li>
