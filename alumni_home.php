...
<?php
$sql="SELECT pi_register, pi_name, pi_gender, pi_address, pi_email, pi_session, pi_branch, pi_mobile, pi_picture, pi_company, pi_position
...
while($row = $result->fetch_assoc()) 
	{
		...
		echo "<tr>";
		echo "<th>Company:</th>";
		echo "<td class=alumnihometd1>".$row["pi_company"]."</td>";
		echo "</tr>";
		echo "<tr>";
		echo "<th>Position in company:</th>";
		echo "<td class=alumnihometd1>".$row["pi_position"]."</td>";
		echo "</tr>";
    }
